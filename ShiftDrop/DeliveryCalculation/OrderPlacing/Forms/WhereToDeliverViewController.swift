//
//  WhereToDeliverViewController.swift
//  ShiftDrop
//
//  Created by Anton Solovev on 25.05.2025.
//
...
class WhereToDeliverViewController: BaseViewController, ButtonViewDelegate {
    ...
    func didTapButton(in view: ButtonView) {
        if validateInputs() {
            ...
            let whoPayForDeliveryViewController = WhoPayForDeliveryViewController(dependencies: dependencies, deliveryInformation: deliveryInformation)
