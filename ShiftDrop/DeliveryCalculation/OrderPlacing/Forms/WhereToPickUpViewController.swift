//
//  WhereToPickUpViewController.swift
//  ShiftDrop
//
...
class WhereToPickUpViewController: BaseViewController, ButtonViewDelegate {
    ...
    func didTapButton(in view: ButtonView) {
        if validateInputs() {
            ...
            let whereToDeliverViewController = WhereToDeliverViewController(dependencies: dependencies, deliveryInformation: deliveryInformation)
